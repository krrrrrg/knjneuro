        ...
        <section id="medical-equipment" data-aos="fade-up">
          <div className="container">
            ...
            <p className="section-description">
              강남제신경과는 여러 의료 장비들을 통해 정확한 진단을 위해
              노력합니다.
            </p>
        ...
        <div className="modal-content">
          ...
          <div className="detail-content">
            <div className="detail-section">
              ...
              <p>
                근전도 검사는 신경과 근육의 전기적 활동을 측정하여 신경 및 근육
                질환을 진단하는 검사입니다. 신경전도검사(NCS)와 함께 시행되어
                말초신경병증, 근육병, 신경근병증 등을 진단하는 데 중요한 역할을
                합니다.
              </p>
            </div>
            <div className="detail-section">
            ...
            <div className="detail-section">
              ...
              <p>
                ...
                신경전도검사에서는 작은 전기 자극을 통해 신경의 전도 속도를
                측정하고, 근전도검사에서는 가는 바늘 전극을 이용해 근육의 전기적
                활동을 기록합니다.
              </p>
            </div>
          </div>
      ...
      <div id="ultrasoundModal" className="modal">
        <div className="modal-content">
          <span
            className="close-button"
            title="닫기"
            onClick={() => hideModal("ultrasoundModal")}
          ></span>
          <h2>초음파 검사</h2>
          <div className="detail-content">
            <div className="detail-section">
              ...
              <p>
                초음파 검사는 고주파 음파를 이용하여 체내 구조물을 실시간으로
                영상화하는 비침습적 검사입니다. 방사선 노출 없이 안전하게 신경,
                근육, 혈관 등의 상태를 확인할 수 있습니다.
              </p>
            </div>
            <div className="detail-section">
              <div className="service-section">
            ...
            <div className="detail-section">
              ...
              <p>
                통증이 없고 방사선 노출이 없어 안전합니다. 실시간으로 영상을
                확인할 수 있어 동적 평가가 가능하며, 필요에 따라 반복 검사가
                가능합니다.
              </p>
            </div>
          </div>
      ...
      <div id="autonomicTestModal" className="modal">
        <div className="modal-content">
          <span
            className="close-button"
            title="닫기"
            onClick={() => hideModal("autonomicTestModal")}
          ></span>
          <h2>자율신경 기능 검사</h2>
          <div className="detail-content">
            <div className="detail-section">
              ...
              <p>
                자율신경 기능 검사는 심장 박동, 혈압, 발한, 체온 조절 등을
                담당하는 자율신경계의 기능을 평가하는 검사입니다. 다양한 생리적
                자극에 대한 신체 반응을 측정합니다.
              </p>
            </div>
            <div className="detail-section">
      ...
      <div id="boneDensityModal" className="modal">
        <div className="modal-content">
          <span
            className="close-button"
            title="닫기"
            onClick={() => hideModal("boneDensityModal")}
          ></span>
          <h2>골밀도 검사</h2>
          <div className="detail-content">
            <div className="detail-section">
              ...
              <p>
                골밀도 검사는 뼈의 밀도를 측정하여 골다공증을 진단하고 골절
                위험을 평가하는 검사입니다. 저선량 X선을 이용하여 주로 척추와
                고관절의 골밀도를 측정합니다.
              </p>
            </div>
            <div className="detail-section">
      ...
      <div id="arterialStiffnessModal" className="modal">
        <div className="modal-content">
          <span
            className="close-button"
            title="닫기"
            onClick={() => hideModal("arterialStiffnessModal")}
          ></span>
          <h2>동맥경화도 검사</h2>
          <div className="detail-content">
            <div className="detail-section">
              ...
              <p>
                동맥경화도 검사는 혈관의 탄력성과 경직도를 측정하여 심혈관
                질환의 위험을 평가하는 검사입니다. 맥파 속도(PWV)와 맥파 증강
                지수(AI)를 측정하여 혈관 건강 상태를 확인합니다.
              </p>
            </div>
            <div className="detail-section">
              <div className="service-section">
              ...
              <p>
                팔과 발목에 혈압 커프를 착용하고 맥파를 측정합니다. 비침습적이고
                통증이 없으며 약 5-10분 정도 소요됩니다. 검사 전 30분간 카페인,
                흡연을 피하고 안정을 취하는 것이 좋습니다.
              </p>
            </div>
            <div className="detail-section">
              <div className="service-section">
      ...
      <div id="bloodTestModal" className="modal">
        <div className="modal-content">
          <span
            className="close-button"
            title="닫기"
            onClick={() => hideModal("bloodTestModal")}
          ></span>
          <h2>종합 혈액검사</h2>
          <div className="detail-content">
            <div className="detail-section">
              ...
              <p>
                종합 혈액검사는 약 80여 가지 항목을 검사하여 전반적인 건강
                상태와 질병 위험을 평가합니다. 혈액 샘플을 통해 다양한 생화학적
                지표, 호르몬, 염증 지표, 영양 상태 등을 확인할 수 있습니다.
              </p>
            </div>
            <div className="detail-section">
              <div className="service-section">
            ...
            <div className="detail-section">
              ...
              <p>
                정확한 결과를 위해 검사 전 8-12시간 금식이 필요합니다. 물은 마실
                수 있으나 카페인, 알코올은 피해야 합니다. 복용 중인 약물이
                있다면 의사와 상담 후 검사를 진행하는 것이 좋습니다.
              </p>
            </div>
          </div>
        </div>
      ...
      <div id="cerebralBloodFlowModal" className="modal">
        <div className="modal-content">
          <span
            className="close-button"
            title="닫기"
            onClick={() => hideModal("cerebralBloodFlowModal")}
          ></span>
          <h2>뇌혈류 초음파</h2>
          <div className="detail-content">
            <div className="detail-section">
              ...
              <p>
                뇌혈류 초음파는 초음파를 이용하여 두개내 혈관의 혈류 속도와
                패턴을 측정하는 비침습적 검사입니다. 뇌졸중 위험 평가, 혈관 협착
                진단, 두개내 혈류 상태 평가 등에 유용합니다.
              </p>
            </div>
            <div className="detail-section">
              <div className="service-section">
              ...
              <p>
                초음파 프로브를 측두골 창(temporal window)이나 안와(orbit),
                후두하(suboccipital) 부위에 위치시켜 두개내 혈관의 혈류를
                측정합니다. 통증이 없고 방사선 노출이 없는 안전한 검사입니다.
              </p>
            </div>
            <div className="detail-section">
              <div className="service-section">
      ...
      <div id="carotidUltrasoundModal" className="modal">
        <div className="modal-content">
          <span
            className="close-button"
            title="닫기"
            onClick={() => hideModal("carotidUltrasoundModal")}
          ></span>
          <h2>경동맥 초음파</h2>
          <div className="detail-content">
            <div className="detail-section">
              ...
              <p>
                경동맥 초음파는 목 부위의 주요 혈관인 경동맥의 구조와 혈류를
                평가하는 비침습적 검사입니다. 동맥경화, 협착, 혈류 이상 등을
                감지하여 뇌졸중 위험을 평가하는 데 중요합니다.
              </p>
            </div>
            <div className="detail-section">
              <div className="service-section">
              ...
              <p>
                초음파 프로브를 목 부위에 위치시켜 경동맥의 내막-중막 두께,
                플라크 유무, 협착 정도, 혈류 속도 등을 측정합니다. 약 15-20분
                소요되며 통증이나 부작용 없이 안전하게 진행됩니다.
              </p>
            </div>
            <div className="detail-section">
              <div className="service-section">
      ...
      <div id="vertigoTestModal" className="modal">
        <div className="modal-content">
          <span
            className="close-button"
            title="닫기"
            onClick={() => hideModal("vertigoTestModal")}
          ></span>
          <h2>어지럼증 검사</h2>
          <div className="detail-content">
            <div className="detail-section">
              ...
              <p>
                어지럼증 검사는 평형기능과 전정기능을 평가하여 어지럼증의 원인을
                파악하는 검사입니다. 전정안구반사, 안진, 자세 안정성 등을
                측정하여 어지럼증의 유형과 원인을 감별합니다.
              </p>
            </div>
            <div className="detail-section">
              <div className="service-section">
      ...
      <div id="cognitiveModal" className="modal">
        <div className="modal-content">
          <span
            className="close-button"
            title="닫기"
            onClick={() => hideModal("cognitiveModal")}
          ></span>
          <h2>인지기능(치매) 검사</h2>
          <div className="detail-content">
            <div className="detail-section">
              ...
              <p>
                인지기능 검사는 기억력, 집중력, 언어능력, 시공간 능력, 실행기능
                등 다양한 인지 영역을 평가하여 치매나 경도인지장애의 조기 발견
                및 진단에 활용되는 검사입니다.
              </p>
            </div>
            <div className="detail-section">
